...
public class PersonalGoalCard11 extends PersonalGoalCard{
    public PersonalGoalCard11(){
        ...
        objective[0][2] = ItemType.PLANT;
        objective[1][1] = ItemType.BOOK;
        objective[2][0] = ItemType.GAME;
        objective[3][2] = ItemType.FRAME;
        objective[4][4] = ItemType.CAT;
        objective[5][3] = ItemType.TROPHY;
    }
    @Override
